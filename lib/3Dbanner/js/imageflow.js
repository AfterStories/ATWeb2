...
function ImageFlow() {
    ...
    this.defaults =
	{
	    ...
	    slideshowSpeed: 2000,           /* Time between slides in ms  自动轮播时间*/
	    slideshowAutoplay: true,          /* Toggle automatic slideshow play on startup 自动轮播*/
	    startID: 1,              /* Image ID to begin with */
	    glideToStartID: true,           /* Toggle glide animation to start ID */
	    startAnimation: false,          /* Animate images moving in from the right on startup */
	    xStep: 100            /* Step width on the x-axis in px 图片重叠间距*/
	};
